...
{% if site.storybooks_page and site.crosslinks %}Start with the [🧒 Kid-Friendly Versions](/docs/articles/kids/) : they explain every concept with stories, analogies, and zero jargon. Then come back to the main articles.{% endif %}
