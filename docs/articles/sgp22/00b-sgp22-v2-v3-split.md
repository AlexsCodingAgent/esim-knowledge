...
← Previous: <a href="{{ site.baseurl }}/docs/articles/sgp22/00-sgp22-overview">eSIM Remote SIM Provisioning (RSP) : How It Works</a> · {% if site.home_link %}<a href="{{ site.baseurl }}/">Home</a>{% else %}<a href="{{ site.baseurl }}/docs/articles/">Specs</a>{% endif %}
