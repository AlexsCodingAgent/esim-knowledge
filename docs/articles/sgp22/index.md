...
| # | Article |
|---|---------|
| 00 | [Overview: The eSIM RSP Technical Specification]({{ site.baseurl }}/docs/articles/sgp22/00-sgp22-overview) |
| 01 | [The eSIM RSP Architecture: Players and Interfaces]({{ site.baseurl }}/docs/articles/sgp22/01-rsp-architecture) |
| 02 | [Inside the eUICC: The Secure Element That Powers Your eSIM]({{ site.baseurl }}/docs/articles/sgp22/02-inside-the-euicc) |
| 03 | [How a Profile Gets Delivered: The eSIM Download Process]({{ site.baseurl }}/docs/articles/sgp22/03-profile-download) |
