...
**{% if site.home_link %}[eUICC.tech]({{ site.baseurl }}/) > {% endif %}[SGP.02 M2M RSP]({{ site.baseurl }}/docs/articles/sgp02/) > SGP.02 vs SGP.22 vs SGP.32: Push, Pull, and the Evolution of eSIM**
