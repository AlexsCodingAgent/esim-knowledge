...
**{% if site.home_link %}[eUICC.tech]({{ site.baseurl }}/) > {% endif %}[SGP.26 Test Certificates]({{ site.baseurl }}/docs/articles/sgp26/) > CRL and Certificate Management in the Test Ecosystem**
...
← Previous: <a href="{{ site.baseurl }}/docs/articles/sgp26/40-sgp26-development">Using Test Certificates: Developer Setup and Integration</a> · {% if site.home_link %}<a href="{{ site.baseurl }}/">Home</a>{% else %}<a href="{{ site.baseurl }}/docs/articles/">Specs</a>{% endif %}
