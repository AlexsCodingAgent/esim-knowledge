...
← Previous: <a href="{{ site.baseurl }}/docs/articles/sgp26/37-sgp26-overview">SGP.26 Overview: The GSMA RSP Test Certificate Infrastructure</a> · {% if site.home_link %}<a href="{{ site.baseurl }}/">Home</a>{% else %}<a href="{{ site.baseurl }}/docs/articles/">Specs</a>{% endif %}
