...
**{% if site.home_link %}[eUICC.tech]({{ site.baseurl }}/) > {% endif %}[SGP.41 IFPP]({{ site.baseurl }}/docs/articles/sgp41/) > The IFPP Architecture: SM-DPf, FPA, and Device Manufacturer**
...
← Previous: <a href="{{ site.baseurl }}/docs/articles/sgp41/47-sgp41-overview">SGP.41 Overview: In-Factory Profile Provisioning</a> · {% if site.home_link %}<a href="{{ site.baseurl }}/">Home</a>{% else %}<a href="{{ site.baseurl }}/docs/articles/">Specs</a>{% endif %}
