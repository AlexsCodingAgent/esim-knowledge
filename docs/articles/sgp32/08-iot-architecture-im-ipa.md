...
**{% if site.home_link %}[eUICC.tech]({{ site.baseurl }}/) > {% endif %}[SGP.32 IoT eSIM]({{ site.baseurl }}/docs/articles/sgp32/) > The eSIM IoT Architecture: eIM, IPA, and the New Interfaces**
...
← Previous: <a href="{{ site.baseurl }}/docs/articles/sgp32/07-iot-esim-why">eSIM for IoT: Why It Needed Its Own Architecture</a> · {% if site.home_link %}<a href="{{ site.baseurl }}/">Home</a>{% else %}<a href="{{ site.baseurl }}/docs/articles/">Specs</a>{% endif %}
