...
The SM-DS must also handle stale events — events for profiles that were cancelled or expired. The deletion is initiatied by the SM-DP+; the SM-DS never autonomously removes events.
