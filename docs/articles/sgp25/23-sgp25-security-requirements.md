...
← Previous: <a href="{{ site.baseurl }}/docs/articles/sgp25/22-sgp25-overview">SGP.25 Overview: The eUICC Common Criteria Protection Profile</a> · {% if site.home_link %}<a href="{{ site.baseurl }}/">Home</a>{% else %}<a href="{{ site.baseurl }}/docs/articles/">Specs</a>{% endif %}
