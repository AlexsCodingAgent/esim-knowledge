...
## Two Kinds of Magic, One Spellbook 📚

| Before v3.x | After v3.x (The Big Team-Up) |
|---|---|
| 📱 Phone magic → one rulebook | 📱 Phone magic + 🤖 Robot magic → **one** rulebook |
| 🤖 Robot magic → separate rulebook | All tricks work the same way everywhere |
| Users pull magic to their phone | Users **or** your mobile company can push magic |
| One profile active at a time | **Multiple profiles** can wear their invisible cloaks at once |

---

## What Makes v3.x Special? ✨
...
## v2.x vs v3.x at a Glance 👀

| Feature | Old Magic (v2.x) | New Unified Magic (v3.x) |
|---|---|---|
| Who starts the magic? | You tap the screen | You **or** your mobile company |
| Profiles active at once | Just one | Several at once |
| Finding out about new keys | Phone walks to Post Office and asks | Post Office rings your magic doorbell |
| Managing keys remotely | Not really possible | Mobile company has a remote control |
| Works with old devices? | N/A | Yes! v3.x is polite to older magic |
...
*Kid-friendly version of [SGP.22 v3.x Overview]({{ site.baseurl }}/docs/articles/sgp22-v3/52-sgp22-v3-overview)*
