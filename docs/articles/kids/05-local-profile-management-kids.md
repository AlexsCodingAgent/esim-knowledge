...
- **Enabled** 🟢 — The profile is active. Your phone's radio sees it and uses it to connect. Only ONE profile can be enabled at a time.

- **Disabled** 🔴 — The profile is installed and ready, but sleeping. It takes up space on the chip but doesn't do anything until you wake it up.
