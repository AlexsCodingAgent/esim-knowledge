...
1. Take off the Home cloak (Disable)
2. The phone briefly loses its connection
3. Put on the Work cloak (Enable)

Like a magician changing outfits behind a curtain: there's always that awkward moment where nothing works!

---

## The New Way: Multiple Cloaks, Multiple Doors 🚪🚪

MEP introduces **eSIM Ports** : think of them as different doors on your phone, each with its own invisible cloak hanging ready:

- **Door 0** : your primary door (maybe for your personal number)
- **Door 1** : your second door (maybe for your work number)
- **Door 2, 3, ...** : even more doors if needed
...
## Three Ways to Organise the Doors 🏗️
...
*Kid-friendly version of [Multiple Enabled Profiles]({{ site.baseurl }}/docs/articles/sgp22-v3/53-multiple-enabled-profiles)*
