...
*[📋 Full Technical Index](/docs/articles/) · [📖 Glossary](/docs/glossary) · [🔢 Status Words](/docs/status-words) · [⚡ Condensed](/ai/status-words) · [🗺️ Standards Map](/docs/standards-map){% if site.storybooks_page and site.crosslinks %} · [📖 Illustrated Edition](/docs/articles/kids/){% endif %}*
{% else %}
